...
import {updateEvent,filterEvents,deleteEvent,createEvent,addServiceToEvent,getAllEventsWithServices,getEventById,removeServiceFromEvent} from "../controller/eventController.js"
const router = Router()
